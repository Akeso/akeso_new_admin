<template>
  <div>
    ...
    <EditOrganization ref="edit" @update-success="getList" />
    <NewOrganization ref="new_organization" @create-success="getList"/>
  </div>
</template>
<script>
import EditOrganization from './components/edit_organization'
import NewOrganization from './components/new_organization'
import { fetchList, deleteItem } from '@/api/weapp/wx_organizations'
export default {
  components: { EditOrganization, NewOrganization },
  data() {
    return {
      list: null,
      total: null,
